define((require, exports, module) => {
  const isArray = require('../../x-is-array/index.js');

  const VNode = require('../vnode/vnode.js');
  const VText = require('../vnode/vtext.js');
  ...
  const isVThunk = require('../vnode/is-thunk.js');

  const parseTag = require('./parse-tag.js');
  const softSetHook = require('./hooks/soft-set-hook.js');
